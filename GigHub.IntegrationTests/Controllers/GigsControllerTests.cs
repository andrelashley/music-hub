...
namespace GigHub.IntegrationTests.Controllers
{
    ...
    public class GigsControllerTests
    {
        ...
        private MusicHub.Controllers.Api.GigsController _apiController;
        ...
        public void SetUp()
        {
            ...
            _apiController = new MusicHub.Controllers.Api.GigsController(new UnitOfWork(_context));
        }
        ...
        //[Test, Isolated]
        //public void Update_WhenCalled_ShouldLogicallyDeleteTheGivenGig()
        //{
        //    // Arrange
        //    var user = _context.Users.First();
        //    _controller.MockCurrentUser(user.Id, user.UserName);
        ...
        //    // Act
        //    var result = _apiController.Cancel(gig.Id);
